...
class BookMarkChildAdapter(
    val content: Context,
    private val listItemModel: List<DuasEntity>,
    val preferenceHelper: PreferenceHelper,
    private val onChildItemClickListener: OnChildItemClickListener
) : RecyclerView.Adapter<BookMarkChildAdapter.ChildViewHolder>() {
    inner class ChildViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val btnBookMark: ImageButton = itemView.findViewById(R.id.btn_bookmark)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChildViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_content_book_mark_duas, parent, false)
    ...
    override fun onBindViewHolder(holder: ChildViewHolder, position: Int) {
        ...
        holder.textDuas.text = childItem.fontName
        holder.textPhoneTic.text = childItem.textIndia
        holder.textLanguage.text = content.getText(childItem.textEnglish)
...
//        holder.textPhoneTic.textSize = preferenceHelper.getFontSize().toFloat()
    ...
    interface OnChildItemClickListener {
        fun onChildItemClick(childItem: DuasEntity)
        fun onChildItemShareClick(childItem: DuasEntity)
    }
}