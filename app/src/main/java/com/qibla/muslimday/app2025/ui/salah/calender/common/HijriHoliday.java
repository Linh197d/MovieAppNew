package com.qibla.muslimday.app2025.ui.salah.calender.common;
...
public enum HijriHoliday {
    ...
    public static Boolean checkDay(LocalDate localDate) {
        for (int i = 0; i < values().length; i++) {
            HijriHoliday day = values()[i];
            System.out.println("check -- [day = " + localDate.getDayOfMonth() + "] -- [month = " + localDate.getMonthValue() + "]");
            if (day.getDay() == localDate.getDayOfMonth() && day.getMonth() == localDate.getMonthValue()) {
                return true;
            }
